...
## 💡 서비스 소개
## 서비스 개요
이 앱은 경북대학교에 재학 중인 외국인 학생들을 대상으로 하여, 학교 생활에 필요한 다양한 정보와 물품 거래, 일상 생활 정보를 공유할 수 있는 커뮤니티 플랫폼입니다. 
<br>
사용자는 기숙사, 학교 시설, 수업 등과 같은 키워드와 함께 리뷰를 등록하고 조회할 수 있습니다.
<br>
사용자는 장터 게시판을 통해 학생 간 물품 거래 또는 나눔 활동에 참여할 수 있습니다.
<br>
사용자는 지도에 등록된 데이터를 통해 일상 생활에 필수적인 정보를 얻을 수 있습니다.
<br>
이 서비스는 외국인 학생들 간의 연결을 강화하고, 더욱 편리하고 원활한 학교 생활을 돕기 위한 목적으로 개발되었습니다.
