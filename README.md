...
4. 외국인 학생 가이드북 제공 + 국제교류처, 한국유학종합시스템, 재외 한국 공관 등 유용 사이트 링크 제공
...
<ol>
    <li><strong>데이터 수집:</strong>
        <ul>
            <li>대구광역시의 의료관광 선도의료기관과 외국환자와 언어소통 가능한 병원 데이터를 공공데이터로부터 받아서 활용하였습니다.</li>
...
<p>
이 구현을 통해 외국인 환자들은 대구광역시에 있는 의료기관의 위치와 제공하는 서비스, 언어 소통 가능 여부 등을 쉽게 확인할 수 있습니다. Google Maps API에 매핑된 데이터는 사용자에게 직관적인 시각적 정보를 제공하여, 의료기관을 찾는 데 필요한 시간을 단축시킵니다.</p>
...
<h2>6. Daily Map -> Google Map API</h2>
<h2>7. 외국인 학생 가이드</h2>
