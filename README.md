...
<ul>
    <li>
        <strong>리뷰 기능</strong>: 사용자는 기숙사, 학교 시설, 수업 등 다양한 키워드를 통해 소중한 경험을 공유하고, 다른 학생들의 리뷰를 쉽게 조회할 수 있습니다.
    </li>
    <li>
        <strong>장터 게시판</strong>: 학생 간 물품 거래 또는 나눔 활동에 참여할 수 있는 장터를 통해 필요한 물건을 쉽게 사고팔거나 나누는 기회를 제공합니다.
    </li>
    <li>
        <strong>지도 기반 정보</strong>: 등록된 데이터를 활용하여 일상 생활에 필수적인 정보를 손쉽게 얻을 수 있으며, 외국인 학생들이 한국 생활에 더욱 적응할 수 있도록 돕습니다.
    </li>
</ul>

<p>
    이 서비스는 외국인 학생들 간의 네트워크를 강화하고, 보다 편리하고 원활한 학교 생활을 지원하기 위해 개발되었습니다. KNU Mingle과 함께 더 풍성한 캠퍼스 경험을 만들어보세요!
</p>
